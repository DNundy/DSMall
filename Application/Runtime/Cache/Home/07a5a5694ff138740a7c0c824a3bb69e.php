...
<head>
    ...
    <link rel="stylesheet" href="/platform/v2/Public/lib/element.min.css">
    <link rel="stylesheet" href="http://p75wjroq9.bkt.clouddn.com/iconfont.css">

    <!-- Main CSS -->
    <link rel="stylesheet" href="/platform/v2/Public/css/index/buy.css">
</head>
        ...
        <el-container>
            ...
            <el-header>
                <div class="headerWrap">
                    <a href="/platform/v2/index.php/Index/index">
                        <span class="logo">DSMall</span>
                    </a>
                    <div class="navLogin">
                        <a href="/platform/v2/index.php/Index/personal" v-if="isLogin">
                            <i class="icon iconfont icon-questions"></i>
                            <span> {{loginInfo}} </span>
                            <span @click="loginOut" class="outLogin"> &nbsp; &nbsp;退出 </span>
                        </a>
                        <a href="/platform/v2/index.php/Login/login" v-else>
                            <i class="icon iconfont icon-questions"></i>
                            <span> 立即登录 </span>
                        </a>
                    </div>
                    <div class="navList">
                        <a href="/platform/v2/index.php/Index/index">首页</a>
                        <a href="/platform/v2/index.php/Index/buy">寻购二货</a>
                        <a href="/platform/v2/index.php/Index/sale">出售二货</a>
                        <a href="/platform/v2/index.php/Index/personal">个人空间</a>
                        <a href="/platform/v2/index.php/Index/contact">关于我们</a>
                    </div>
                </div>
            </el-header>
            ...
            <el-main v-loading="crumbsLoading">
                ...
                <div class="goodsList"  v-if="goodsInfo.msg" v-loading="serachStatus">
                    <div class="goodsItem" v-for="(item,index) in goodsInfo.msg">
                        <a :href="'/platform/v2/index.php/Index/detail?id='+item.g_id">
                            <img :src="'/platform/v2/Public/img/goods/'+imgList[index]" alt="">
            ...
            <el-footer>
                <div class="links">
                    <script async src="//dn-lbstatics.qbox.me/busuanzi/2.3/busuanzi.pure.mini.js"></script><span class="footer-mid">您是第&nbsp;&nbsp;<span id="busuanzi_value_site_uv"></span>&nbsp;&nbsp;位小伙伴 !</span><a href="/platform/v2/index.php/Index/index">系统首页</a> |
                    <a href="/platform/v2/index.php/Login/login.html">用户登录</a> |
                    <a href="/platform/v2/index.php/Login/loginAdmin.html">管理员登录</a>
                </div>
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                loadingLogin: function (params) {
                    let url = '/platform/v2/index.php/Login/isLoginUser';
                    let _that = this;
                    $.ajax({
                        url: url,
                        dataType: 'JSON',
                ...
                loginOut: function (params) {
                    let url = '/platform/v2/index.php/Login/out_login';
                    let _that = this;
                    $.ajax({
                        url: url,
                        dataType: 'JSON',
                        success: function (data) {
                            ...
                            location = '/platform/v2/index.php/Login/login'
                        },
                        error: function () {
                            _that.$message({
                                message: '网络 或者 服务器出错,请稍后重试！',
                ...
                serachGoods: function (params) {
                    let url = '/platform/v2/index.php/Index/searchGoods';
                    let _that = this;
                    if (_that.serachCont == '') {
                        _that.getGoods();
                        return;
                ...
                getType: function (params) {
                    let url = '/platform/v2/index.php/Index/findType';
                    let _that = this;
                    $.ajax({
                        url: url,
                        dataType: 'JSON',
                ...
                // 获取商品列表
                getGoods: function () {
                    let url = '/platform/v2/index.php/Index/indexGoods';
                    let _that = this;
                    // 开启加载图标
